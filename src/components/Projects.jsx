          ...
          >
            ...
            <div className="flex flex-col shadow-md shadow-primary container rounded-md mx-auto content-div bg-bgblack">
              ...
              <div className='p-4 flex flex-col justify-between h-full'>
                ...
                <a className='flex items-center justify-evenly w-[60%] md:w-[50%] border-2 text-offwhite font-semibold border-primary px-4 py-2 hover:bg-primary hover:scale-105 hover:text-bgblack duration-300 rounded cursor-pointer' href='https://github.com/Dyxelta/eduverse'>
            ...
            <div className="flex flex-col shadow-md shadow-primary container rounded-md mx-auto content-div bg-bgblack">
              ...
              <div className='p-4 flex flex-col justify-between h-full'>
                ...
                <a className=' flex items-center justify-evenly w-[60%] md:w-[50%] border-2 text-offwhite font-semibold border-primary px-4 py-2 hover:bg-primary hover:scale-105 hover:text-bgblack duration-300 rounded cursor-pointer' href='https://github.com/RifianFernando/FINance-BE'>
                  <FaGithub></FaGithub> Repository
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col shadow-md shadow-primary container rounded-md mx-auto content-div bg-bgblack">
              ...
              <div className='p-4 flex flex-col justify-between h-full'>
                ...
                <a className='flex items-center justify-evenly w-[60%] md:w-[50%] border-2 text-offwhite font-semibold border-primary px-4 py-2 hover:bg-primary hover:scale-105 hover:text-bgblack duration-300 rounded cursor-pointer' href='https://github.com/RifianFernando/PSD-Project-LAB'>
                  <FaGithub></FaGithub> Repository
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col shadow-md shadow-primary container rounded-md mx-auto content-div bg-bgblack">
              ...
              <div className='p-4 flex flex-col justify-between h-full'>
                ...
                <a className='flex items-center justify-evenly w-[60%] md:w-[50%] border-2 text-offwhite font-semibold border-primary px-4 py-2 hover:bg-primary hover:scale-105 hover:text-bgblack duration-300 rounded cursor-pointer' href='https://github.com/Dyxelta/Project-HCI'>
                  <FaGithub></FaGithub> Repository
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col shadow-md shadow-primary container rounded-md mx-auto content-div bg-bgblack">
              ...
              <div className='p-4 flex flex-col justify-between h-full'>
                ...
                <a className=' flex items-center justify-evenly w-[60%] md:w-[50%] border-2 text-offwhite font-semibold border-primary px-4 py-2 hover:bg-primary hover:scale-105 hover:text-bgblack duration-300 rounded cursor-pointer' href='https://github.com/Dyxelta/Sunbic'>
                  <FaGithub></FaGithub> Repository
                </a>
              </div>
            </div>
